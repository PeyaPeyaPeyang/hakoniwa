...
public class PrintlnTrapProvider implements InvocationTrapProvider {
    ...
    public void registerTraps(InvocationTrapRegistry registry) {
        registry.register(new PrintlnInvocationTrap(
                ...
                new ClassMethod(
                        ...
                        MethodDescriptor.parse("checkMethodInvocation(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V"))));
    }
}
